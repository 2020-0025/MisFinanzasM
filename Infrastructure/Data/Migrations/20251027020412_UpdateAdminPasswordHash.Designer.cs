...
namespace MisFinanzas.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251027020412_UpdateAdminPasswordHash")]
            ...
            modelBuilder.Entity("MisFinanzas.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3c36277d-fef5-4b4c-a991-22b0db55fd1b",
                            ...
                            SecurityStamp = "524e6bed-4463-4b24-817d-6bd201afc36d",
                            UserName = "admin",
                            UserRole = "Admin"
                        });
                });
